...
var import_readable_web_to_node_stream = __toESM(require_lib());
...
var FileTypeParser = class {
  ...
  async toDetectionStream(readableStream, options = {}) {
    const { default: stream } = await import("./node_stream-4YDEN2GY.js");
...
async function imageType(input) {
  ...
  return imageExtensions.has(result == null ? void 0 : result.ext) && result;
}
var minimumBytes2 = 4100;
export {
  imageType as default,
  minimumBytes2 as minimumBytes
};
