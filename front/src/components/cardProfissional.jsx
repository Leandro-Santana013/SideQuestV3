...
import '../styles/cardProfissional.css'
        ...
        <div className="desc-cliente">
            ...
            <div className="content-desc">
                <p className="desc" id="maix">
                    ...
                    comerciais, incluindo a instalação de novos sistemas elétricos, reparos de fiação e iluminação.
                </p>
                <span className="vma-vme" onClick={verMaisEMenos}>ver mais</span>
            </div>
        </div>
