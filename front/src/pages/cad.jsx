...
const Cad = () => {
    ...
    const toggleForm = () => {
        setIsProfessional((prevValue) => !prevValue);
    };
                ...
                <div className="r-side">
                    ...
                    <div className="campos">
                        ...
                        <label className="btn-slide">
                            <input type="checkbox" id="toggleButton" onChange={toggleForm} />
                            <span className="slider"></span>
                        </label>
                        <form action="/auth/register" method="post" className={`formCliente ${isProfessional ? 'hidden' : ''}`}>
                        ...
                        <form action="/auth/registerPro" method="post" className={`formProfi ${isProfessional ? '' : 'hidden'}`}>
